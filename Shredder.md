...
## What’s the issue?
  - "Auto-stop" would not engage, and a discomforting noise occured during operation.
...
## Approach (diagnosis → teardown → cleanup → test)
  ...
  - Used a chainsaw tooth sharpener to file down the damaged plastic spacers.
...
## Results
  ...
  - Auto-stop engages as intended. Running noise is normal!
